        ...
        <MDBCarouselInner>
          <MDBCarouselItem itemId='1' className='carousel-text'>
            <MDBView>
              ...
              <p className='carousel-text-inner'>
                I really appreciate it. it is so good! Even in short notice I
                was happy with your job to be honest Everyone commenting your
                job
              </p>
          ...
          <MDBCarouselItem itemId='2' className='carousel-text'>
            <MDBView>
              <h3 className='h3-responsive'>Testimonials</h3>
              <p className='carousel-text-inner'>
                It’s very nice, Because of you I have fine pictures from that
                day, I’ve been sending pictures since morning
              </p>
          ...
          <MDBCarouselItem itemId='3' className='carousel-text'>
            <MDBView>
              <h3 className='h3-responsive'>Testimonials</h3>
              <p className='carousel-text-inner'>
                Good morning, thank you🙏🏼🙏🏼. The videos are nice, we want more
                😁
              </p>
